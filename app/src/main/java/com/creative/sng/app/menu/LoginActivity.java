...
public class LoginActivity extends AppCompatActivity {
    ...
    @BindView(R.id.editText1) EditText _sabun_no;
    @BindView(R.id.editText2) EditText _user_sosok;
    @BindView(R.id.editText3) EditText _user_nm;
    @BindView(R.id.editText4) EditText _user_pw;
    @BindView(R.id.button1) Button loginButton;
