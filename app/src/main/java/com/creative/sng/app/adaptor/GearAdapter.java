...
public class GearAdapter extends BaseAdapter {
    ...
    public GearAdapter(Context con, ArrayList<HashMap<String, Object>> array){
        inflater = LayoutInflater.from(con);
        gearList = array;
        this.con = con;
    }

    public GearAdapter(Context con, ArrayList<HashMap<String, Object>> array, String name){
        inflater = LayoutInflater.from(con);
        gearList = array;
        this.con = con;
        this.name= name;
    ...
    @Override
    public int getCount() {return gearList.size();}
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(v == null){
            ...
            v = inflater.inflate(R.layout.gear_check_daily_write_item, parent, false);
...
//            20190517 항목6 작업후는 색깔변경
            if (gearList.get(position).get("ord").toString().equals("A")) {
